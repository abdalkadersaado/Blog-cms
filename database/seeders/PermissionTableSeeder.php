...
class PermissionTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        // POSTS
        $managePosts = Permission::create(['name' => 'manage_posts', 'display_name_en' => 'Posts', 'display_name' => 'ادارة القالات', 'route' => 'posts', 'module' => 'posts', 'as' => 'posts.index', 'icon' => 'fas fa-newspaper', 'parent' => '0', 'parent_original' => '0', 'appear' => '1', 'ordering' => '5',]);
        $managePosts->parent_show = $managePosts->id;
        $managePosts->save();
        $showPosts = Permission::create(['name' => 'show_posts', 'display_name_en' => 'Posts', 'display_name' => 'ادارة القالات', 'route' => 'posts', 'module' => 'posts', 'as' => 'posts.index', 'icon' => 'fas fa-newspaper', 'parent' => $managePosts->id, 'parent_show' => $managePosts->id, 'parent_original' => $managePosts->id, 'appear' => '1', 'ordering' => '0',]);
