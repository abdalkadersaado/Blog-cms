...
<body>
  ...
  <!-- ***** Header Area Start ***** -->
            ...
            <div class="row">
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <!-- ***** Menu Start ***** -->
                        <ul class="nav">
                            <li class="scroll-to-section"><a href="{{ route('dar.home') }}" >Home</a></li>
                            ...
                            <li class="scroll-to-section"><a href="{{ route('dar.contact') }}">Contact Us</a></li>
                        </ul>
    ...
    <!-- ***** Header Area End ***** -->
            ...
            <form action="{{ route('get_quote') }}"  method="post" autocomplete="off">
            @csrf
        ...
        <section class="heading-page header-text" id="top">
            ...
            <div class="row">
                <div class="col-lg-12">
                <h6>{{ __('Frontend/general.change_password') }}</h6>
                    ...
                    <div class="meeting-single-item">
                        <div class="down-content bodyk">
                            ...
                            <div class="title__container">
                                <h1>{{ __('Frontend/general.change_password') }}</h1>
                            </div>
                            <div class="body__container">
                                <div class="left__container">
                                    <div class="side__titles">
                                        <div class="title__name">
                                            <h3>Your Current Password and New password</h3>
