...
<html lang="en">
  ...
  <head>
    ...
    <title>Dar AlNuzum</title>
     ...
     <!-- Bootstrap core CSS -->
    <link href="{{ asset('DAR-ALNUZUM1/vendor/bootstrap/css/bootstrap.min.css') }}" rel="stylesheet">
    <!-- Additional CSS Files -->
    <link rel="stylesheet" href="{{ asset('DAR-ALNUZUM1/assets/css/fontawesome.css') }}">
    <link rel="stylesheet" href="assets/css/templatemo-edu-meeting.css">
    <link rel="stylesheet" href="{{ asset('DAR-ALNUZUM1/assets/css/templatemo-edu-meeting.css') }}">
    ...
    <body>
                        ...
                        <nav class="main-nav">
                            ...
                            <ul class="nav">
                               ...
                               <li class=""><a href="{{ route('about.us') }}">About </a></li>
                                <li class="nav-item dropdown has-megamenu">
                                    <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown" style="padding: 0;">
                                        @if (auth()->user())
                                           {{ auth()->user()->name}}
                                        @endif
                                   </a>
                ...
                <div class="owl-service-item owl-carousel">
                    @forelse ($posts as $post )
                        ...
                        <div class="down-content">
                            <h4><a {{ route('frontend.posts.show', $post->url_slug()) }}>{{\Illuminate\Support\Str::limit($post->title(),25,'...')  }}</a></h4>
                    ...
                    <div class="col-lg-12">
                        ...
                        <ul class="fil-cla">
                            ...
                            @foreach($global_categories as $global_category)
                                <li data-filter="*"  class="active"><a href="{{ route('frontend.filter_category', $global_category->url_slug()) }}" style="color: white">{{ $global_category->name() }}</a></li>
                            @endforeach
        ...
        <section class="contact-us" id="contact">
            ...
            <div class="footer">
                <div class="footer-flex">
                    ...
                    <a href="{{ route('dar.home') }}">Home</a>
                    <a href="index.html">Services</a>
                    <a href="index.html">Blogs</a>
                    <a href="{{ route('dar.contact') }}">Contact Us</a>
                    </div>
                    <div class="contact">
        ...
        <script src="{{ asset('DAR-ALNUZUM1/assets/js/custom.js') }}"></script>
            ...
            <script src="{{ asset('DAR-ALNUZUM1/vendor/bootstrap/js/bootstrap.min.js') }}"></script>
